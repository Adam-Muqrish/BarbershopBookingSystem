...
public class CustomerDAO {
	...
	public String insertCustomer(Customer customer) {
		...
		try (Connection conn = DBUtil.getConnection();
			...
			String hashedPassword = BCrypt.hashpw(customer.getCustPassword(), BCrypt.gensalt());
	...
	public boolean verifyPassword(Customer customer, String inputPassword) {
	    String storedHash = customer.getCustPassword();
	    return storedHash != null && org.mindrot.jbcrypt.BCrypt.checkpw(inputPassword, storedHash);
	}
	...
	// Update loyalty points, reset to 0 if exceeding 10
	public boolean updateLoyaltyPoints(String custId, int points) {
		int updatedPoints = points > 10 ? 0 : points;
