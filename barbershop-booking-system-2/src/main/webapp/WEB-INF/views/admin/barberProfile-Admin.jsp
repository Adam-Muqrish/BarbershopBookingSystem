								        ...
								        <div class="nk-block-head-content w-100">
								            <div class="d-flex justify-content-center">
								                <div class="media media-huge media-circle">
								                    <c:choose>
													    <c:when test="${not empty staff.staffPicture}">
													        <img src="${pageContext.request.contextPath}/uploads/${staff.staffPicture}" 
													             class="img-thumbnail" 
													             alt="Staff Picture"
                                                            ...
                                                            <div class="bio-block">
                                                                ...
                                                                <ul class="list-group list-group-borderless small">
																    <li class="list-group-item d-flex">
																	    ...
																	    <span class="text text-break">${staff.staffName}</span>
																	</li>
																	<li class="list-group-item d-flex">
																	    <span class="fw-medium" style="min-width: 130px;">Email:</span>
																	    <span class="text text-break">${staff.staffEmail}</span>
																	</li>
																	<li class="list-group-item d-flex">
																	    <span class="fw-medium" style="min-width: 130px;">Phone Number:</span>
																	    <span class="text text-break">${staff.staffPhoneNumber}</span>
																	</li>
																	<li class="list-group-item d-flex">
																	    <span class="fw-medium" style="min-width: 130px;">Description:</span>
																	    <span class="text">${staff.description}</span>
																	</li>
																</ul>
                                                            </div><!-- .bio-block -->
                                                        </div><!-- .card-body -->
